...
;All const string
Main@main$$cstr_1 db "obj.obj2.obj1.n1 = ", 0
Main@main$$cstr_2 db "obj1.n1 = ", 0
Main@main$$cstr_3 db "#############################", 10, 0
Main@main$$cstr_4 db 10, 0
Main@main$$cstr_5 db "##########Occurred an exception", 10, 0
c1@func$$cstr_1 db "c1::func, n1 = ", 0
;All const double
;All const float
...
c2@$$signature_str db "c2", 0
c3@$$signature_str db "c3", 0
