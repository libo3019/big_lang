...
class1@func1@0@s1 db 0, 0, 0, 0
class1@func1@1@s1 db 0, 0, 0, 0
...
;All const string
class1@func1$$cstr_1 db "s1 = ", 0
class1@func1$$cstr_2 db "another s1 = ", 0
;All const double
;All const float
...
mov eax, class1@func1@0@s1 ;The variable's address
...
add esp, 8
;Get the value of variable or field or type 's1' start
mov eax, class1@func1@1@s1 ;The variable's address
;Get the value of variable or field 's1' end
