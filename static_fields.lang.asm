...
;All const string
Main@main$$cstr_1 db "obj1.s1 = ", 0
Main@main$$cstr_2 db "class1.s1 = ", 0
class1@func2$$cstr_1 db "s1 = ", 0
;All const double
;All const float
...
class1@$$signature_str db "class1", 0
clear@$$signature_str db "clear", 0
func1@$$signature_str db "func1", 0
func2@$$signature_str db "func2", 0
...
;Method: _class1@func1
_class1@func1:
push ebp
mov ebp, esp
mov eax, 3
push eax ;save the right expression value
;Get the value of variable or field or type 's1' start
mov eax, class1@s1 ;The variable's address
;Get the value of variable or field 's1' end
...
;Method: _class1@func2
_class1@func2:
push ebp
mov ebp, esp
mov eax, class1@func2$$cstr_1
push eax
push _printstrstr
call _printf
add esp, 8
...
call _bdwgc_malloc
add esp, 4
mov dword [eax], class1@$$classdescriptor ;mov the class descriptor item address to the object's start address
add eax, 4
mov [esp+4], eax ;//save the new memory's address
push class1@$$signature_str
push none@$$classname_str
push dword [esp+12]
...
push class1@$$classname_str
push none@$$classname_str
call _PushStaticMethodName
add esp, 12
;static call start
call _class1@func1
add esp, 0 ;not stdcall
mov [esp+4], eax
call _PopMethodName
mov eax, [esp+4]
add esp, 8
...
call _GetMethodNameDeque
mov [esp], eax
;Get the value of variable or field or type 'class1' start
;Get the value of variable or field 'class1' end

push func2@$$signature_str
push class1@$$classname_str
push none@$$classname_str
call _PushStaticMethodName
add esp, 12
